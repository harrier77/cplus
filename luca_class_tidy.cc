...
void parla (int posx, int posy, string type, string frase = "", int txtx =
	    posTxtx, int txty = posTxty, string keyp = keyParla);
void draw (int firstx, int firsty, int secondx = -1, int secondy =
	   -1, string type = wall, bool vuoto = false);
...
void
print (int thisx, int thisy, string tile, bool printLand)
{
...
void
parla (int posx, int posy, string type, string frase, int txtx, int txty,
       string keyp)
{
  if (!init)
...
void
draw (int firstx, int firsty, int secondx, int secondy, string type,
      bool vuoto)
{
  int l, h;
